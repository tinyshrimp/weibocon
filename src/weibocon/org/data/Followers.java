...
public class Followers {
	 ...
	 * @return the fandNun
	 */
	public Integer getFandNun() {
		return FandNun;
	}
	/**
	 * @param fandNun the fandNun to set
	 */
	public void setFandNun(Integer fandNun) {
		FandNun = fandNun;
	}
	/**
	 ...
	 * @return the idoNum
	 */
	public Integer getIdoNum() {
		return IdoNum;
	}
	/**
	 * @param idoNum the idoNum to set
	 */
	public void setIdoNum(Integer idoNum) {
		IdoNum = idoNum;
	}
	/**
	 * @return the favouritesNum
	 */
	public Integer getFavouritesNum() {
		return FavouritesNum;
	}
	/**
	 * @param favouritesNum the favouritesNum to set
	 */
	...
	/**
	 * @param crate_at the crate_at to set
	 */
	...
	/**
	 * @param folowing the folowing to set
	 */
